...
켤 수 있습니다. 글꼴 크기는 적응형입니다. 8×6인치 기준 크기표를 그림의 실제 크기에 비례해 조절하고(0.6~1.3배), 서브플롯이
n개면 1/√n으로 줄이며, 3D 축은 눈금 라벨이 겹치기 쉬워 0.8배와 눈금 5개 이하로 두고 제목 자리(상단 8%)를 비워 둡니다.
런처의 **Font scale**(50~200%)로 전체 배율을 더 조절할 수 있습니다. 그림 창마다 있는 **Publication figure…** 버튼은 현재
그림을 8×6인치 안에 맞춘 뒤 논문용 글꼴 크기(제목 24, 축 22, 눈금 20, 범례 18 pt; 서브플롯 수와 Font scale 반영)로
