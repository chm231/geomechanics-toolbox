...
try
    ...
    handles.text5=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[0.08 0.04 0.38 0.17],'String',['Injection Pressure' ...
...
function handles=Callmnmesh(hObject,eventdata,handles)%todo
...
function CallRadSta(hObject,eventdata,handles)%todo
...
function CallRadcty(hObject, eventdata, handles)%todo
...
function CallRadpty(hObject, eventdata, handles)%todo
...
function CallRadptyr(hObject, eventdata, handles)%todo
...
function CallRadptyth(hObject, eventdata, handles)%todo
...
function CallPlot(hObject, eventdata, handles)%todo
...
function handles=Callmnsave(hObject,eventdata,handles)%todo
...
function CallRad1mn(hObject,eventdata,handles)%todo
...
function CallRad2mn(hObject,eventdata,handles)%todo
...
function handles=Callmnsaveok(hObject,eventdata,handles)%todo
...
function CallDetail(hObject, eventdata, handles)%todo
