...
fig1 = figure('position', [500 200 600 500],'Color',[240/255,240/255,240/255],'MenuBar','none','Resize','off');
...
handles.title=uicontrol('style','text','units','normalized','position',[40/600 440/500 520/600 50/500],'string', 'Borehole Stability Analyzer', 'FontName','Times New Roman', 'FontSize',28);

handles.option=uibuttongroup('title', 'Select Option', 'Position', [5.6 34.857 56.8 3.643]);

handles.pmatrix=uicontrol('style', 'popupmenu', 'units','normalized', 'position', [40/600 400/500 245/600 20/500],'string', '3D Elastic Modulus Matrix(Voigt)|3D Compliance Matrix(Voigt)','backgroundcolor',[1 1 1],'Value',2);
handles.elatable=uitable('units','normalized', 'position', [40/600 270/500 245/600 120/500], ...
    'Data', zeros(6), ...
    'ColumnEditable', [true true true true true true], ...
    'ColumnName', [], 'RowName', [], ...
    'ColumnFormat', {'short','Numeric','Numeric','Numeric','Numeric','Numeric'}, ...
    'ColumnWidth', {40 40 40 40 40 40},'Data',[0.02 -0.004 -0.004 0 0 0; -0.004 0.02 -0.004 0 0 0; -0.004 -0.004 0.02 0 0 0; 0 0 0 0.048 0 0; 0 0 0 0 0.048 0; 0 0 0 0 0 0.048]);
handles.text1=uicontrol('style','text', 'units','normalized', 'position', [160/600 250/500 140/600 18/500], 'String', '(Unit : GPa or 1/GPa)');
handles.pan1=uipanel('Title','Boundary Condition', 'Position', [50/600 20/500 225/600 200/500]);

handles.text2=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[10/245 150/200 70/245 30/200],'String','Sx(SHmax) ', 'HorizontalAlignment', 'right');
handles.text3=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[10/245 120/200 70/245 30/200],'String','Sy(Shmin) ', 'HorizontalAlignment', 'right');
handles.text4=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[20/245 90/200 60/245 30/200],'String','Sz ', 'HorizontalAlignment', 'right');
handles.RadFlu=uicontrol('parent',handles.pan1,'style','radiobutton','units','normalized','position',[20/245 60/200 200/245 30/200], 'String', 'Fluid Injection');
handles.text5=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[20/245 30/200 60/245 30/200],'String','Fluid Pressure ', 'HorizontalAlignment', 'right');
handles.text6=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[160/245 150/200 50/245 30/200],'String','MPa ', 'HorizontalAlignment', 'left');
handles.text7=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[160/245 120/200 50/245 30/200],'String','MPa', 'HorizontalAlignment', 'left');
handles.text8=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[160/245 90/200 50/245 30/200],'String','MPa ', 'HorizontalAlignment', 'left');
handles.text9=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[160/245 25/200 50/245 30/200],'String','MPa ', 'HorizontalAlignment', 'left');
handles.edit2=uicontrol('parent',handles.pan1,'style','edit','units','normalized','position',[90/245 160/200 60/240 20/200],'backgroundcolor',[1 1 1],'HorizontalAlignment','right','String','0');
handles.edit3=uicontrol('parent',handles.pan1,'style','edit','units','normalized','position',[90/245 130/200 60/240 20/200],'backgroundcolor',[1 1 1],'HorizontalAlignment','right','String','0');
handles.edit4=uicontrol('parent',handles.pan1,'style','edit','units','normalized','position',[90/245 100/200 60/240 20/200],'backgroundcolor',[1 1 1],'HorizontalAlignment','right','String','0');
handles.edit5=uicontrol('parent',handles.pan1,'style','edit','units','normalized','position',[90/245 35/200 60/240 20/200],'backgroundcolor',[1 1 1],'HorizontalAlignment','right','Enable','off','String','0');
set(handles.RadFlu,'callback',{@CallRadFlu,handles})

handles.bgroup1=uibuttongroup('title', 'Select Analysis', 'Position', [330/600 360/500 225/600 60/500]);
handles.RadAna=uicontrol('parent',handles.bgroup1,'style','radiobutton','units','normalized','position',[20/245 5/60 140/245 50/60], 'string', 'Analytic Solution');
handles.RadFEM=uicontrol('parent',handles.bgroup1,'style','radiobutton','units','normalized','position',[150/245 5/60 60/245 50/60], 'string', 'FEM');

handles.pan2=uipanel('Title','Thermal Properties','Position',[330/600 230/500 225/600 120/500]);
handles.RadThe=uicontrol('parent',handles.pan2,'style','radiobutton','units','normalized','position',[20/245 90/130 200/245 30/130], 'String', 'Thermal Effect');
handles.text10=uicontrol('parent',handles.pan2,'style','text','units','normalized','position',[20/245 50/130 80/245 35/130],'String','Temperature Change ', 'HorizontalAlignment', 'right');
handles.text11=uicontrol('parent',handles.pan2,'style','text','units','normalized','position',[20/245 10/130 80/245 35/130],'String','Expansion Coef. ', 'HorizontalAlignment', 'right');
handles.edit6=uicontrol('parent', handles.pan2,'style', 'edit','units','normalized','position',[110/245 60/130 60/245 23/130],'backgroundcolor',[1 1 1],'HorizontalAlignment','right', 'Enable','off','String','0');
handles.edit7=uicontrol('parent', handles.pan2,'style', 'edit','units','normalized','position',[110/245 20/130 60/245 23/130],'backgroundcolor',[1 1 1],'HorizontalAlignment','right','Enable','off','String','0');
handles.text12=uicontrol('parent',handles.pan2,'style','text','units','normalized','position',[180/245 50/130 50/245 30/130],'String','K ', 'HorizontalAlignment', 'left');
set(handles.RadThe,'callback',{@CallRadThe,handles})

handles.pan3=uipanel('Title','Borehole Information', 'Position', [330/600 100/500 225/600 120/500]);
handles.text13=uicontrol('parent',handles.pan3,'style','text','units','normalized','position',[20/245 125/200 80/245 50/200],'String','Radius ', 'HorizontalAlignment', 'right');
handles.text14=uicontrol('parent',handles.pan3,'style','text','units','normalized','position',[20/245 70/200 80/245 50/200],'String','Polar Angle ', 'HorizontalAlignment', 'right');
handles.text15=uicontrol('parent',handles.pan3,'style','text','units','normalized','position',[20/245 30/200 80/245 50/200],'String','Azimuthal Angle ', 'HorizontalAlignment', 'right');
handles.edit8=uicontrol('parent', handles.pan3,'style', 'edit','units','normalized','position',[110/245 145/200 60/245 35/200],'backgroundcolor',[1 1 1],'HorizontalAlignment','right','String','0.1');
handles.edit9=uicontrol('parent', handles.pan3,'style', 'edit','units','normalized','position',[110/245 90/200 60/245 35/200],'backgroundcolor',[1 1 1],'HorizontalAlignment','right','String','0');
handles.edit10=uicontrol('parent', handles.pan3,'style', 'edit','units','normalized','position',[110/245 35/200 60/245 35/200],'backgroundcolor',[1 1 1],'HorizontalAlignment','right','String','0');
handles.text16=uicontrol('parent',handles.pan3,'style','text','units','normalized','position',[180/245 120/200 50/245 50/200],'String','m', 'HorizontalAlignment', 'left');
handles.text17=uicontrol('parent',handles.pan3,'style','text','units','normalized','position',[180/245 70/200 50/245 50/200],'String','degree', 'HorizontalAlignment', 'left');
handles.text18=uicontrol('parent',handles.pan3,'style','text','units','normalized','position',[180/245 15/200 50/245 50/200],'String','degree', 'HorizontalAlignment', 'left');

handles.Run=uicontrol('style','pushbutton','units','normalized','String','Run','position',[350/600 55/500 185/600 30/500]);
handles.Reset=uicontrol('style','pushbutton','units','normalized','String','Reset','position',[350/600 15/500 185/600 30/500]);
...
Gsxi=str2double(get(handles.edit2, 'String'))*10^6;
Gsyi=str2double(get(handles.edit3, 'String'))*10^6;
Gszi=str2double(get(handles.edit4, 'String'))*10^6;
Gfp=0;
if get(handles.RadFlu,'value')==1
    Gfp=str2double(get(handles.edit5, 'String'))*10^6;
end
Gtc=0;
Gec=0;
...
stressdevmat=[(sin(-Gpol))^2 (cos(-Gpol)*cos(-Gazi))^2 (cos(-Gpol)*sin(-Gazi))^2;
    ...
    %sin 이었던거 cos으로 바꿈
devst=stressdevmat*[Gszi;Gsxi;Gsyi];
Gsx=devst(1);
Gsy=devst(2);
Gsz=devst(3);
Gtyz=devst(4);
...
for countr=1:length(r)
    ...
    for countth=1:length(theta)
        ...
        zeta1(countr,countth)=(z1(countr,countth)/R + detert1(countr,countth))/(1-1i*mu(1));
        ...
        Phi1(countr,countth)=-(1/(2*Del*zeta1(countr,countth)*detert1(countr,countth)))    *((1i*Gtxy - Gsy+Gfp)*(mu(2)-lbd(2)*lbd(3)*mu(3))+(Gtxy-1i*Gsx+1i*Gfp)*(lbd(2)*lbd(3)-1)+(Gtyz-1i*Gtxz)*lbd(3)*(mu(3)-mu(2)));
        ...
        Sxx(countr,countth)=Gsx+2*real(mu(1)^2*Phi1(countr,countth)+mu(2)^2*Phi2(countr,countth)+(lbd(3)*mu(3)^2)*Phi3(countr,countth));
...
handles.Detail=uicontrol('style','pushbutton','units','normalized','position',[525/750, 20/500, 150/750, 30/500],'string','Detail');
