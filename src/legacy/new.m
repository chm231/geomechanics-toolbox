...
handles.text2=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[0.172 0.77 0.277 0.13],'String','Sx(SHmax) ', 'HorizontalAlignment', 'right');
handles.text3=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[0.172 0.64 0.277 0.12],'String','Sy(Shmin) ', 'HorizontalAlignment', 'right');
handles.text4=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[0.26 0.523 0.18 0.10],'String','Sz ', 'HorizontalAlignment', 'right');
...
handles.text6=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[0.786 0.75 0.126 0.14],'String','MPa ', 'HorizontalAlignment', 'left');
handles.text7=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[0.786 0.62 0.126 0.14],'String','MPa', 'HorizontalAlignment', 'left');
handles.text8=uicontrol('parent',handles.pan1,'style','text','units','normalized','position',[0.786 0.48 0.11 0.14],'String','MPa ', 'HorizontalAlignment', 'left');
...
handles.edit2=uicontrol('parent',handles.pan1,'style','edit','units','normalized','position',[0.5 0.81 0.25 0.08],'backgroundcolor',[1 1 1],'HorizontalAlignment','right','String','0');
handles.edit3=uicontrol('parent',handles.pan1,'style','edit','units','normalized','position',[0.5 0.68 0.25 0.08],'backgroundcolor',[1 1 1],'HorizontalAlignment','right','String','0');
handles.edit4=uicontrol('parent',handles.pan1,'style','edit','units','normalized','position',[0.5 0.55 0.25 0.08],'backgroundcolor',[1 1 1],'HorizontalAlignment','right','String','0');
...
if one==1
    ...
    stressdevmat=[(sin(-Gpol))^2 (cos(-Gpol)*cos(-Gazi))^2 (cos(-Gpol)*sin(-Gazi))^2; %Tsig를 적당히 변형한 것
    ...
    devst=stressdevmat*[Gszi;Gsxi;Gsyi];  %시추공 좌표계로 변환된 응력값
    Gsx=devst(1);
    Gsy=devst(2);
    Gsz=devst(3);
    Gtyz=devst(4);
